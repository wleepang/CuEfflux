...
# plot the result
pdf(file='odeCuEfflux_straincompare_twochap_lp.pdf', width=11, height=8.5, paper='USr')
...
barplot(result[,'cu.ss'], names.arg=rownames(result), xpd = F, ylab='[Cu]', ylim=c(175,250))
